...
protected:
    ...
    void SetUp() override {
        ...
        for (const auto& u : auth.listUsers())
            if (u.username == "access_viewer") viewer_id = u.user_id;
        ...
        m1.bind(1, "movie-r");  m1.bind(2, "Restricted Movie"); m1.bind(3, "/media/movie-r.mkv");
        m1.bind(4, 5400000);    m1.bind(5, "R");
        m1.exec();

        SQLite::Statement m2(db.get(),
            "INSERT INTO movie(movie_id, title, file_path, duration_ms, content_rating) VALUES (?,?,?,?,?)");
        m2.bind(1, "movie-g");  m2.bind(2, "Kid-Safe Movie"); m2.bind(3, "/media/movie-g.mkv");
        m2.bind(4, 5400000);    m2.bind(5, "G");
        m2.exec();

        SQLite::Statement s1(db.get(),
            "INSERT INTO show(show_id, title, content_rating) VALUES (?,?,?)");
        s1.bind(1, "show-ma"); s1.bind(2, "Restricted Show"); s1.bind(3, "TV-MA");
        s1.exec();
        ...
        c1.bind(1, "chan-ma"); c1.bind(2, "Restricted Channel"); c1.bind(3, 1); c1.bind(4, "TV-MA");
        c1.exec();
    }
